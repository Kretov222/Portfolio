<h1>Таблица с данными, выполненная по макету на Figma</h1>
...
<h3>Чтобы запустить проект: </h3>
<ul>
  <li>Установить зависимости => npm i</li>
  <li>Просмотреть файл .env.example и настроить свое окружение соответствующим образом.</li>
</ul>
<h4>Client</h4>
<ul>
  <li>Ввести : npm run dev</li>
</ul>
<h4>Server</h4>
<ul>
  <li>Ввести : npm run start</li>
</ul>
